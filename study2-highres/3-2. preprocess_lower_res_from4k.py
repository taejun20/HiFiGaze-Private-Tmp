...
def main():
    parser = argparse.ArgumentParser(description="Create eyecrops and 478-point landmark json files for all resolutions.")
    parser.add_argument(
        "--data-root",
        type=Path,
        default=Path("study1_rawdata_processed"),
        help="Root directory containing p*/ folders (default: study1_rawdata_processed).",
    )
    parser.add_argument(
        "-s",
        "--subjects",
