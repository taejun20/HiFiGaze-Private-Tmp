...
from models.GazeModel_RGB_WIDER import GazeModel_RGB_WIDER  
...
DEFAULT_CKPT = CHECKPOINT_DIR / (
    "RGB_500_WIDER_train_p2,6,7,8,10,11,12,13,15,16,19,25_Epoch12_TrainLoss0.613.pt"
)
...
def _load_model_weights(model: GazeModel_RGB_WIDER, ckpt_path: Path, device: torch.device) -> None:
...
def evaluate_all_subjects(
    ...
    *,
    ...
    model = GazeModel_RGB_WIDER().to(device)
