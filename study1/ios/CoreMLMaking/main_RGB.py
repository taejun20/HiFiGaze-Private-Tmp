...
CHECKPOINT = "checkpoints/RGB_IOS_train_all_subjects_Epoch20_TrainLoss0.039.pt"
OUTPUT = "GazeModelRGB_e20.mlpackage"
...
with torch.no_grad():
    traced_model = torch.jit.trace(model, (left_eye, right_eye, eye_landmarks, face_landmarks))
