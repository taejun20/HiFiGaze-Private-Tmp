...
class GazeModelRGB_FFHA(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        # MLP head
        self.fc4 = nn.Linear(1280 + 1280 + 1280 + 16 + 16, 8)
        self.fc5 = nn.Linear(8, 4)
        self.fc6 = nn.Linear(4, 2)

    def forward(self, face, left_eye, right_eye, eye_landmarks, headaug_landmarks):
        ...
        headaug_landmarks_tensor = F.relu(self.fc1_landmarks_headaug(headaug_landmarks))
        headaug_landmarks_tensor = F.relu(self.fc2_landmarks_headaug(headaug_landmarks_tensor))
        headaug_landmarks_tensor = F.relu(self.fc3_landmarks_headaug(headaug_landmarks_tensor))
