...
class GazeModelH_ED(nn.Module):
    def __init__(self):
        ...
        # MLP head
        self.fc4 = nn.Linear(256 + 256 + 1 + 16, 8)  # Added 2 for valid flags
        self.fc5 = nn.Linear(8, 4)
        self.fc6 = nn.Linear(4, 2)

    def forward(self, left_heatmap, right_heatmap, eye_dominance, eye_landmarks):
