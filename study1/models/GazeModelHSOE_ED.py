...
class GazeModelHSOE_ED(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.heatmap_cnn = nn.Sequential(
            ...
            nn.Flatten(),
            nn.Linear(32 * 10 * 13, 256)  # Output size of 16 features
        )
        ...
        # MLP head
        self.fc4 = nn.Linear(256 + 256 + 4 + 1 + 1 + 1 + 16, 8)  # Added 2 for valid flags
        self.fc5 = nn.Linear(8, 4)
        self.fc6 = nn.Linear(4, 2)

    def forward(self, left_heatmap, right_heatmap, soe_landmarks, eye_dominance, eye_landmarks):
