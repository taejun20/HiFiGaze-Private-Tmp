...
class GazeModelRGBTSOE_ED(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        # MLP head
        self.fc4 = nn.Linear(1280 + 1280 + 256 + 4 + 1 + 1 + 1 + 16, 8)  # Added 2 for valid flags
        self.fc5 = nn.Linear(8, 4)
        self.fc6 = nn.Linear(4, 2)

    def forward(self, left_eye, right_eye, template, soe_landmarks, eye_dominance, eye_landmarks):
